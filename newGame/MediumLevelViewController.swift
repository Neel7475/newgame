//
//  MediumLevelViewController.swift
//  newGame
//
...
class MediumLevelViewController: UIViewController {
    ...
    @IBAction func alertRestartButton(_ sender: Any) {
        let hear = self.storyboard?.instantiateViewController(withIdentifier: "MediumLevelViewController") as! MediumLevelViewController
